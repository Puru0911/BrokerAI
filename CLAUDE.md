...
**Core Value**: Eliminate the pain of manually searching, messaging dozens of people, and negotiating. The AI does the heavy lifting while keeping humans in control.
...
- **LLM Providers**: OpenAI (primary) + Anthropic (Claude) — accessed via LangChain
